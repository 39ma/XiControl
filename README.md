...
лимит заряда, «В дорогу» (разовый заряд до 100%), тачпад вкл/выкл, авто-герцовка
и «режим совы» (не спать).*
...
- ⚙️ **Окно «Настройки»** в стиле Windows 11 — все опции по вкладкам (Общие / Батарея /
  Экран / Производительность / Клавиши / О программе), тёмная и светлая темы.
...
автозапуск, запоминание яркости, сова, тачпад), Батарея (звук «В дорогу»), Экран
(авто-герцовка и частоты), Производительность (видимость режимов, режим при старте,
профили питания), Клавиши (переназначение) и О программе. Быстрые переключатели
...
«В дорогу», тачпад вкл/выкл, системные «Проекция (Win+P)» / «Параметры Windows» /
«Copilot (Win+C)», запуск своей программы или «Ничего».

Тачпад отключается штатным механизмом Windows (как «Отключить устройство» в Диспетчере,
без драйверов) и **всегда включается сам после перезагрузки** — залипнуть выключенным
не может. Ячейка тачпада есть и в быстрой панели, рядом с авто-герцовкой.
...
on/off, a Windows 11-style settings window, remappable Mi button and special keys
