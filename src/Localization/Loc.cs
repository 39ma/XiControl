...
public static class Loc
{
    ...
    private static readonly Dictionary<string, string[]> S = new()
    {
        ...
        ["menu.profiles"]            = ["Профили питания", "Power profiles", "电源配置"],
        ["menu.profiles.ac"]         = ["От сети", "On AC", "交流供电"],
        ["menu.profiles.battery"]    = ["От батареи", "On battery", "电池供电"],
        ["menu.profiles.none"]       = ["Не менять", "Don't change", "保持不变"],
        ["menu.profiles.brightness"] = ["Запоминать яркость экрана", "Remember screen brightness", "记住屏幕亮度"],
